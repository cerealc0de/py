...
class Total_Class:
    ...
    def WriteCells(self,sheet,column=0,line=3):
        ...
        sheet.write(line,12+column,self.rr-(self.fee_percent/100))
...
def ImportTrades(log,line_number):
    ...
    for trade in trades:
        ...
        #print(str(poi_types[trade.poi_type]))
    return trades
...
def PrintItemLine(sheet,item,column,line,first_column):
    ...
    sheet.write(line,12+column,item.rr-(item.commission_percent/100))
